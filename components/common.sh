...
SYSTEMD_SETUP() {
    ...
    sed -i -e 's/MONGO_DNSNAME/mongodb.krishna.roboshop/' -e 's/REDIS_ENDPOINT/redis.krishna.roboshop/' -e 's/MONGO_ENDPOINT/mongodb.krishna.roboshop/' -e 's/CATALOGUE_ENDPOINT/catalogue.krishna.roboshop/' -e 's/CARTENDPOINT/cart.krishna.roboshop/' -e 's/DBHOST/mysql.krishna.roboshop/' /home/roboshop/${component}/systemd.service
    status_check $?
